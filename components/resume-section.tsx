...
export default function ResumeSection({ section, animationComplete }: ResumeSectionProps) {
  const container = {
    hidden: { opacity: 0 },
    show: {
      opacity: 1,
  ...
  return (
    <motion.div className="space-y-4" initial="hidden" animate="show" variants={container}>
      ...
      {section.content.map((paragraph, index) => (
        <motion.div key={index} variants={item} className="prose max-w-none">
          {typeof paragraph === "string" ? <p className="text-gray-700">{paragraph}</p> : <div>{paragraph}</div>}
        </motion.div>
      ))}
        ...
        <motion.div variants={item} className="mt-6 space-y-4">
          {section.items.map((item, index) => (
            ...
            >
              ...
              {item.subtitle && <div className="text-blue-600">{item.subtitle}</div>}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div>
                ...
                <div className="text-blue-600">your.email@example.com</div>
              </div>
            </a>
            <a
            ...
            >
              ...
              <div>
                ...
                <div className="text-blue-600">github.com/yourusername</div>
              </div>
            </a>
            <a
              href="tel:+1234567890"
